/* ——— Produtos e correlatos: navegação mais clara ———
   ...
   - Telas mais limpas, por nível (perfil › blocos › etapas › itens, como no núcleo
     ...
     telas); sem a faixa repetida “Produtos e correlatos / Alterar perfil”; sem a
     “Base legal” que repetia o botão de citação do item; rodapé do roteiro sem
     botão cortado e fora das abas Infrações e Relatório. */
(function(){
 ...
 var ocupado=false;
 function tudo(){if(ocupado)return;ocupado=true;try{botoes();titulo();passos();pop13();cnae();nivel()}catch(e){}ocupado=false}
