...
- **Verificação de IFA (Distribuidora)** refeita em `distribuidora-ifa.js`: fichas de amostra salvas no roteiro, consulta única às bases públicas (CADIFA, CBPF com validade na data da inspeção, banco de IFA, AFE/AE do fornecedor e do destinatário pelo fragmento correto do CNPJ, Portaria 344), conferência documental e saída no item 11.2 do relatório. A ferramenta antiga não achava AFE (buscava só o primeiro arquivo da base), não lia as listas da Portaria 344 e deixava “finalidade: distribuição” sem conclusão.
