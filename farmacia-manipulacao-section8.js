...
(function (window, document) {
  ...
  function text(){var s=FM.get(BASE,{}),lines=['MONITORAMENTO DO PROCESSO MAGISTRAL E DA ÁGUA'];[['aguaPurificada','Água purificada'],['aguaPotavel','Água potável'],['baseGalenica','Base galênica'],['baixaDose','Fármaco ≤ 25 mg'],['diluido','Diluído preparado'],['sensibilizantes','Sensibilizantes']].forEach(function(x){var ev=((s[x[0]]||{}).eventos)||[];if(ev.length)lines.push(x[1]+': '+ev.map(function(e){return [e.certificados,e.amostra,e.lote,e.coleta,e.resultado].filter(Boolean).join(' · ');}).join('; '));});return lines.join('\n');}
