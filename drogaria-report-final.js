...
(() => {
  ...
  function manualIssues(s,base){
    ...
    const ql=sec(s,'documentos_qualidade');
  ...
  function start(){let tries=0;const go=()=>{if(window.DrogariaFinalBridge&&window.DrogariaReview&&install())return;if(++tries<200)setTimeout(go,25);};go();}
