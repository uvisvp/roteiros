...
function ddRelatorioView(){
 ...
 return '<div class="panel"><h3>Relatório de inspeção — Anexo I (POP-O-SNVS-011 rev. 3)</h3><p class="mini">O relatório segue a numeração fixa do modelo (itens 1 a 19). Esta tela reúne os campos que não vêm do roteiro. Os itens 7 a 12 são montados com a “Descrição para o relatório” de cada bloco do roteiro; sem ela, o texto é redigido a partir das respostas Cumpre, e as não conformidades saem sempre, numeradas como no Anexo II.</p><ol class="dd-fluxo"><li><b>Prévia</b> — a qualquer momento, para conferência.</li><li><b>Anexo II</b> — entregue à empresa ao fim da inspeção (aba Não conformidades).</li><li><b>Análise do plano de ação</b> — documento Word próprio (aba Análise do plano de ação).</li><li><b>Par técnico e aprovação</b>.</li><li><b>Relatório final único</b> — Anexo I + Anexo A (análise do plano) + registro fotográfico.</li></ol><div class="toolbar"><button class="btn" type="button" data-dd-prev>Ver prévia</button><button class="btn primary" type="button" data-dd-prevdoc>Baixar prévia (.docx)</button></div></div>'+
